...
################################################################################
"""
Description: Preprocessing function for training.
...
def preprocessing(dat):
    ...
    dat2["Pr"] = dat2[["n_Patv","n_Prtv"]].apply(f3,axis=1) # Not use
    dat2["Tdiff"] = dat2["n_Itmp"]-dat2["n_Etmp"]
        
        
    def unknown_judge(x): # Mainly use for FilterMSEloss
    ...
    return    dat2[["TurbID","Day","Tmstamp","Wspd","Wdir","Etmp", \
