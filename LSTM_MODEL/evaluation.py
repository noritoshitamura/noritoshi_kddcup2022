...
DATA_DIR = './data/'#os.path.normpath(os.path.join(os.path.dirname(os.path.realpath(__file__)), '../data'))
REQUIRED_ENV_VARS = [
    "pred_file",
    "checkpoints",
    "start_col",
...
def evaluate(path_to_src_dir):
    ...
    envs["path_to_test_x"] = "./data/sdwpf_baidukddcup2022_test_toy/test_x"
    envs["path_to_test_y"] = "./data/sdwpf_baidukddcup2022_test_toy/test_y"
