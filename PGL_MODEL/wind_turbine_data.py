...
class WindTurbineData(Dataset):
    ...
    def __get_turbine__(self, turbine_id):
        ...
        if self.task == 'MS':
            ...
            df_data = df_data_[["wind_dir","Ndir","n_Itmp","Area","Wp","Prtv","n_Etmp","onoff","Patv"]]
        elif self.task == 'S':
    ...
    def get_scaler(self, turbine_id):
        #print("Scaler",WindTurbineData.scaler_collection[turbine_id].mean)
