...
__all__ = ["FilterMSELOSS2","FilterMSELOSS", "MSELoss", "HuberLoss", "MAELoss", "SmoothMSELoss"]


class FilterMSELoss2(nn.Layer):
    def __init__(self, **kwargs):
        super(FilterMSELoss2, self).__init__()

    def forward(self, pred, gold, raw, col_names):
        # Remove bad input
        cond1 = raw[:, :, :, col_names["onoff"]] < 0

        cond = paddle.logical_not(cond1)
